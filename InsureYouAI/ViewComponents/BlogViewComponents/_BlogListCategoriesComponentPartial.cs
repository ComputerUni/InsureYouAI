...
namespace InsureYouAI.ViewComponents.BlogViewComponents
{
    public class _BlogListCategoriesComponentPartial : ViewComponent
    {
        ...
        public IViewComponentResult Invoke()
        {
            ...
            var categories = _context.Categories.Select(c => new CategoryArticleCountViewModel { CategoryId = c.CategoryId, CategoryName = c.CategoryName, ArticleCount = c.Articles.Count() }).ToList();
